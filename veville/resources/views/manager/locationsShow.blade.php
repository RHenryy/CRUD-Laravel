...
@section('content')
    <div class="container">
        ...
        @if ($managers[0]->id_agency === $locations[0]->id_agency)
        ...
        @else
            @if (!$contacts->isEmpty())
                <div style="text-align:center">
                    <a id="showModal" style="width:20%;padding:0.5rem;" class="btn btn-dark">Prenez rendez-vous maintenant
                        !</a>
                @else
                    <h3 class="mt-4" style="font-weight:bold;text-decoration: underline;">L'appartement n'est pas/plus
                        disponible à la
                        location pour le moment</h3>
                    <a href="/agencies/show/{{ $locations[0]->id_agency }}" class="btn btn-primary">Contactez l'agence
                        pour
                        plus
                        d'informations</a>
            @endif
    ...
    <div id="myCarousel" class="carousel slide container mb-3 mt-5 w-75" data-bs-ride="carousel" data-bs-interval="false">
