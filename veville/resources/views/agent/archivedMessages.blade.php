...
<div class="container mt-5 mb-3">
    ...
    <form style="width: 100%;" method="post" action="/agent/messages/restore/{{ $message->id_booking }}" class="group-form">
        @csrf

      
   <input type="submit" class="w-25 mt-4 btn btn-danger" value="Restaurer Message">
...
@endforeach
    <div class="container">
        <a href="/agent/messages"><button type="button" class="btn btn-primary w-25">Retour aux messages</button></a>
    </div>
