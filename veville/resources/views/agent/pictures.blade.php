...
<div class="container text-center">
    ...
    <p class="h4 mb-3">Appartment : {{ $locations[0]->title_location }} - {{ $locations[0]->city }}</p>
<img src="{{ asset('storage/' . $locations[0]->photo) }}" alt="{{$locations[0]->title_location}}">
<form class="mt-4" method="post" action="/agent/pictures/{{ $locations[0]->id_location }}" enctype="multipart/form-data">
    @csrf
...
<div class="container text-left align-middle mw-25 mt-4">
    ...
    <ul class="pictureList">
        <li class="mb-3">
    <img style="max-width:25%;" src="{{ asset('storage/'. $image->src) }}"><a href="/agent/pictures/delete/{{ $locations[0]->id_location }}/{{ $image->id }}">---
